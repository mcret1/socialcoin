                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SocialCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&socialcoin Project"), this);
    webmainAction->setStatusTip(tr("socialcoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("socialcoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("socialcoin Twitter"));
    ...
    discordAction->setStatusTip(tr("socialcoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("socialcoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("socialcoin Telegram"));
    ...
    redditAction->setStatusTip(tr("socialcoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap socialcoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell socialcoin Coin (socialcoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    socialcoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&socialcoin block explorer"), this);
    socialcoinBlockExplorerAction->setStatusTip(tr("socialcoin blockchain explorer"));
    socialcoinBlockExplorerAction->setToolTip(socialcoinBlockExplorerAction->statusTip());
    socialcoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&socialcoin Project Github"), this);
    githubAction->setStatusTip(tr("socialcoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a socialcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and socialcoin: URIs)"));
...
//    }
    ...
    connect(socialcoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(socialcoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About socialcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about socialcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for socialcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your socialcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified socialcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a socialcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the socialcoin Core help message to get a list with possible socialcoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(socialcoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("socialcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.socialcoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/socialcoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/socialcoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/socialcoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/socialcoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::socialcoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/socialcoin/socialcoin/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to socialcoin network", "", count));
}
...
{
    QString strTitle = tr("socialcoin Core"); // default title
