...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 socialcoin at the same time
...
{
private:
    int GetDepthInMainChaisocialcoinERNAL(const CBlockIndex*& pindexRet) const;
...
public:
    ...
    {
        const CBlockIndex* pindexRet;
        return GetDepthInMainChaisocialcoinERNAL(pindexRet) > 0;
    }
