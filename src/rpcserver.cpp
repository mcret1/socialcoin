...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop socialcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "socialcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* socialcoin features */
        {"socialcoin", "masternode", &masternode, true, true, false},
        {"socialcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"socialcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"socialcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"socialcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"socialcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"socialcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"socialcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"socialcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"socialcoin", "startmasternode", &startmasternode, true, true, false},
        {"socialcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"socialcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"socialcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"socialcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"socialcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"socialcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"socialcoin", "mnbudget", &mnbudget, true, true, false},
        {"socialcoin", "preparebudget", &preparebudget, true, true, false},
        {"socialcoin", "submitbudget", &submitbudget, true, true, false},
        {"socialcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"socialcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"socialcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"socialcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"socialcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"socialcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"socialcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"socialcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"socialcoin", "mnsync", &mnsync, true, true, false},
        {"socialcoin", "spork", &spork, true, true, false},
        {"socialcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> socialcoin-cli " + methodname + " " + args + "\n";
}
