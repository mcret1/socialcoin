...
This means one can have an always-on socialcoind instance running, and another local socialcoind/socialcoin-qt instance which connects to this node and receives blocks from it.
