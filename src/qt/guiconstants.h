...
/* socialcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "socialcoin"
#define QAPP_ORG_DOMAIN "socialcoinproject.org"
#define QAPP_APP_NAME_DEFAULT "socialcoin-Qt"
#define QAPP_APP_NAME_TESTNET "socialcoin-Qt-testnet"
