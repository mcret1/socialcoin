...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("socialcoin socialcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  socialcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded socialcoin transaction") + "\n" +
                               "  socialcoin-tx [options] -create [commands]   " + _("Create hex-encoded socialcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded socialcoin transaction
