...
/** Utility functions used by the socialcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render socialcoin addresses in monospace font
...
// Parse "socialcoin:" URI into recipient object, return true on successful parsing
