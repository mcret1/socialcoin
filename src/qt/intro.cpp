...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("socialcoin Core"),
     ...
     * override -datadir in the socialcoin.conf file in the default data directory
     * (to be consistent with socialcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
