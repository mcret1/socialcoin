...
CBlockTemplate* CreateNewBlock(const CScript& scriptPubKeyIn, CWallet* pwallet, bool fProofOfStake)
{
...

    {
        ...
        LogPrint("socialcoin", "CreateNewBlock(): total size %u\n", nBlockSize);
...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock)) {
        ...
        return error("socialcoinMiner : ProcessNewBlock, block not accepted");
    }
...
{
    LogPrintf("socialcoinMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrint("socialcoin", "Running socialcoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
