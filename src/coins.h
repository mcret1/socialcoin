...
/** 
    ...
    ****Note - for socialcoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of socialcoin coming in to a transaction
