...
In order to support loading of multiple wallets in socialcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is socialcoin.cpp.
...
Changes to socialcoin.cpp
----------------------
socialcoin.cpp is the entry point into socialcoin-qt, and as such, will require some minor modifications to provide hooks for
