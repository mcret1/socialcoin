...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "socialcoin is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1622243899;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 6156952;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xc2d8d9001249ff5f9cd5b8f57cfe362d889359a3ae430f08bf3eead1e9e9d0ef"));
        assert(hashGenesisBlock == uint256("0x000001be6a72db7960f3445c855e84ebf48f6259512d3621012a9ff26757692c"));

     
		
	vSeeds.push_back(CDNSSeedData("141.164.41.18","141.164.41.18"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xc2d8d9001249ff5f9cd5b8f57cfe362d889359a3ae430f08bf3eead1e9e9d0ef"));
        assert(hashGenesisBlock == uint256("0x0000523a279f6ff8041a146cfd805ea42d904e384bb72814d183a18062cb2831"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xc2d8d9001249ff5f9cd5b8f57cfe362d889359a3ae430f08bf3eead1e9e9d0ef"));
        assert(hashGenesisBlock == uint256("0x18022e43fd5a120a87a2689e5bdb3d4da4069adb7e16a42822c8bd0ec2944f93"));
