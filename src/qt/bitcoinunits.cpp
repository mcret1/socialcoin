...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case socialcoin:
            return QString("tSSC");
        case mECA:
            return QString("mtSSC");
        case uECA:
            return QString::fromUtf8("μtSSC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case socialcoin:
            return QString("SSC");
        case mECA:
            return QString("Milli-SSC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-SSC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case socialcoin:
            return QString("TestSSC");
        case mECA:
            return QString("Milli-TestSSC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestSSC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
