Contributing to socialcoin Core
============================

The socialcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the socialcoin Core project, and is not to be
confused with overall socialcoin Network Protocol consensus changes.

Whether a pull request is merged into socialcoin Core rests with the project merge
...
Patches that change socialcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the socialcoin consensus, it must have been
...
The project leader is the release manager for each socialcoin Core release.
